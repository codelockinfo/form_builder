...
<div class="Polaris-Page">
    <div
        class="Polaris-Page-Header Polaris-Page-Header--hasActionMenu Polaris-Page-Header--noBreadcrumbs Polaris-Page-Header--mediumTitle">
            ...
            <div class="Polaris-Page-Header__RightAlign">
                ...
                <div id="myBtn_new" class="Polaris-Page-Header__PrimaryActionWrapper">
                    <button class="Polaris-Button Polaris-Button--primary" type="button">
                        <span class="Polaris-Button__Content"><span class="Polaris-Button__Text">Create new
                                form</span></span>
                    </button>
                </div>
            </div>
        ...
        <div
            class="Polaris-ResourceList__HeaderWrapper border-radi-botom-unset Polaris-ResourceList__HeaderWrapper--hasAlternateTool Polaris-ResourceList__HeaderWrapper--hasSelect Polaris-ResourceList__HeaderWrapper--isSticky">
                ...
                <div class="Polaris-ResourceList__CheckableButtonWrapper">
                        ...
                        <label class="Polaris-Choice">
                            <span class="Polaris-Choice__Control">
                                <span class="Polaris-Checkbox">
                                    <input name="chekbox1" type="checkbox" class="Polaris-Checkbox__Input"
                    ...
                    <div class="bultActionss">
                        <div class="Polaris-ButtonGroup Polaris-ButtonGroup--segmented"
                            ...
                            <div class="Polaris-ButtonGroup__Item">
                                <div
                                    class="Polaris-CheckableButton Polaris-CheckableButton__CheckableButton--selectMode Polaris-CheckableButton__CheckableButton--selected">

                                    <div class="Polaris-CheckableButton__Checkbox">
                                        <label class="Polaris-Choice">
                                            <span class="Polaris-Choice__Control">
                                                <span class="Polaris-Checkbox">
                                                    <input name="chekbox1" type="checkbox"
                                                        class="Polaris-Checkbox__Input checkAllCount"
                            ...
                            <div class="Polaris-ButtonGroup__Item">
                                <div>
                                    <div>
                                        <div class="Polaris-BulkActions__BulkActionButton">
                                            <!-- <button class="Polaris-Button" type="button" tabindex="0"
                                            ...
                                            <select name="" id="" class="Polaris-Button">
                                                <option value="">More actions</option>
                                                <option value="">Delete form</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div style="display: flex;">
                        <div class="Polaris-Labelled--hidden">
                            <div class="Polaris-Labelled__LabelWrapper">
                                <div class="Polaris-Label"><label id="PolarisSelect9Label" for="PolarisSelect9"
                                        class="Polaris-Label__Text">Sort by</label></div>
                            </div>
                            <div class="Polaris-Select">
                                ...
                                <div class="Polaris-Select__Content" aria-hidden="true">
                                    <span class="Polaris-Select__InlineLabel">Sort by</span><span
                                        class="Polaris-Select__SelectedOption">Newest</span>
                                ...
                                <div class="Polaris-ButtonGroup__Item">
                                    <div class="Polaris-CheckableButton">
                                        <label class="Polaris-Choice">
                                            <span class="Polaris-Choice__Control">
                                                <span class="Polaris-Checkbox">
                                                    <input name="chekbox2" type="checkbox"
                                    ...
                                    <div class="Polaris-BulkActions__BulkActionButton">
                                        <button class="Polaris-Button" type="button">
                                            <span class="Polaris-Button__Content"><span
                                                    class="Polaris-Button__Text">Duplicate selected
                                                    form(s)</span></span>
                                        </button>
                                    </div>
                                </div>
                                <div class="Polaris-ButtonGroup__Item">
                                    <div>
                                        <div>
                                            <div class="Polaris-BulkActions__BulkActionButton">
                                                <button class="Polaris-Button" type="button"
                                                    aria-controls="Polarispopover21" aria-owns="Polarispopover21"
                                                    aria-expanded="false">
                                                    <span class="Polaris-Button__Content">
                                                        <span class="Polaris-Button__Text">More actions</span>
                                                        <span class="Polaris-Button__Icon">
...
<div id="myModal_new" class="modal">
    <form id="createNewForm" class="create_new_frm" name="create_new_form" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" class="formnamedescriptionhide" name="formdeswcriptionhide"
            value="Leave your message and we'll get back to you shortly.">
