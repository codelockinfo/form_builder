                    ...
                    <div class="Polaris-ResourceList__CheckableButtonWrapper">
                        <div class="Polaris-CheckableButton Polaris-CheckableButton__CheckableButton--plain">
                            ...
                            <div class="main_left_">
                                ...
                                <div class="sp-font-size">Cart form</div>
                            </div>
                                        ...
                                        <span tabindex="0" aria-describedby="PolarisTooltipContent58" data-polaris-tooltip-activator="true">
                                            <span class="Polaris-Icon Polaris-Icon--colorBase Polaris-Icon--applyColor">
                                                ...
                                                <svg viewBox="0 0 20 20" class="Polaris-Icon__Svg" focusable="false" aria-hidden="true">
                                                    ...
                                                    <path
                                                        d="M16 10a1 1 0 0 1 1 1v4.5a1.5 1.5 0 0 1-1.5 1.5h-7.864l-2.818 2.707a1 1 0 0 1-1.707-.707v-2h-1.611a1.5 1.5 0 0 1-1.5-1.5v-11a1.5 1.5 0 0 1 1.5-1.5h7.5a1 1 0 0 1 0 2h-7v10h2.111a1 1 0 0 1 1 1v.697l1.404-1.404a1 1 0 0 1 .707-.293h7.778v-4a1 1 0 0 1 1-1zm0-5a.999.999 0 0 1-.707-1.707l2-2a1 1 0 1 1 1.414 1.414l-2 2a.996.996 0 0 1-.707.293zm3 1a1 1 0 1 1 0 2h-2a1 1 0 1 1 0-2h2zm-6-2a1 1 0 0 1-1-1v-2a1 1 0 0 1 2 0v2a1 1 0 0 1-1 1z"
                                                    ></path>
                                                </svg>
                                            </span>
                                        </span>
                    ...
                    <div class="Polaris-ResourceList__CheckableButtonWrapper">
                        <div class="Polaris-CheckableButton Polaris-CheckableButton__CheckableButton--plain">
                            <label class="Polaris-Choice">
                                <span class="Polaris-Choice__Control">
                                  <span class="Polaris-Checkbox">
                                    <input name="chekbox5" type="checkbox" class="Polaris-Checkbox__Input" aria-invalid="false" role="checkbox" aria-checked="false" value="">
                                    <span class="Polaris-Checkbox__Backdrop">
                                    </span>
                                    <span class="Polaris-Checkbox__Icon">
                                      <span class="Polaris-Icon">
                        ...
                        <div class="Polaris-BulkActions__Group Polaris-BulkActions__Group--largeScreen Polaris-BulkActions__Group--exited">
                            <div class="Polaris-BulkActions__ButtonGroupWrapper">
                                <div class="Polaris-ButtonGroup Polaris-ButtonGroup--segmented" data-buttongroup-segmented="true">
                                    <div class="Polaris-ButtonGroup__Item">
                                        <div class="Polaris-CheckableButton">
                                            <label class="Polaris-Choice" for=":R1n6:">
                                                <span class="Polaris-Choice__Control">
                                                  <span class="Polaris-Checkbox">
                                                    <input id=":R1n6:" type="checkbox" class="Polaris-Checkbox__Input" aria-invalid="false" role="checkbox" aria-checked="false" value="">
                                                    <span class="Polaris-Checkbox__Backdrop">
                                                    </span>
                                                    <span class="Polaris-Checkbox__Icon">
                                                      <span class="Polaris-Icon">
                    ...
                    <div class="Polaris-ResourceList__CheckableButtonWrapper">
                        <div class="Polaris-CheckableButton Polaris-CheckableButton__CheckableButton--plain">
                            <label class="Polaris-Choice">
                                <span class="Polaris-Choice__Control">
                                  <span class="Polaris-Checkbox">
                                    <input name="chekbox7" type="checkbox" class="Polaris-Checkbox__Input" aria-invalid="false" role="checkbox" aria-checked="false" value="">
                                    <span class="Polaris-Checkbox__Backdrop">
                                    </span>
                                    <span class="Polaris-Checkbox__Icon">
                                      <span class="Polaris-Icon">
                                    ...
                                    <div class="Polaris-ButtonGroup__Item">
                                        <div class="Polaris-CheckableButton">
                                            <label class="Polaris-Choice">
                                                <span class="Polaris-Choice__Control">
                                                  <span class="Polaris-Checkbox">
                                                    <input name="chekbox6" type="checkbox" class="Polaris-Checkbox__Input" aria-invalid="false" role="checkbox" aria-checked="false" value="">
                                                    <span class="Polaris-Checkbox__Backdrop">
                                                    </span>
                                                    <span class="Polaris-Checkbox__Icon">
                                                      <span class="Polaris-Icon">
