...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo main_url('assets/css/customstyle1.css?v='.time()); ?>" rel="stylesheet">
        <link rel="stylesheet" href="<?php echo main_url('assets/css/style3.css?v=' . time()); ?>" rel="stylesheet">
        ...
        <script src="<?php echo main_url('assets/js/style3.js'); ?>"></script>
        <script src="<?php echo main_url('assets/js/shopify_client10.js?v=' . time()); ?>"></script>
