        ...
        if (isset($_POST['store']) && $_POST['store'] != '') {
            ...
            if (empty($error_array)) {
                ...
                // $last_id = $this->db->insert_id;
                    ...
                    $top_header_visibility = (isset($_POST['selectedType']) && in_array($_POST['selectedType'], [3, 5, 7])) ? "0" : "1";
            ...
            if (isset($comeback_client['data']) && is_array($comeback_client['data'])) {
                foreach ($comeback_client['data'] as $templates) {
                    ...
                    $html .= '<div class="Polaris-ResourceList__HeaderWrapper border-radi-unset Polaris-ResourceList__HeaderWrapper--hasAlternateTool Polaris-ResourceList__HeaderWrapper--hasSelect Polaris-ResourceList__HeaderWrapper--isSticky">
                                <div class="Polaris-ResourceList__HeaderContentWrapper" style="display: flex; justify-content: space-between; align-items: center;">
                                    <div class="Polaris-ResourceList__CheckableButtonWrapper" style="flex: 1;">
                                        <div class="Polaris-CheckableButton Polaris-CheckableButton__CheckableButton--plain" style="display: flex; align-items: center; gap: 15px; width: 100%;">
                                            ';
                    if (!isset($_POST['view_type']) || $_POST['view_type'] != 'submissions_dashboard') {
                        $html .= '<label class="Polaris-Choice" style="margin: 0; min-width: 24px; padding-left: 8px;">
                    ...
                    $html .= '
                                    ...
                                    <div class="111 Polaris-ResourceList__AlternateToolWrapper main_right_">
                                        ';
                    if (!isset($_POST['view_type']) || $_POST['view_type'] != 'submissions_dashboard') {
                        $html .= '<div class="svgicon" style="width: 60px; display: flex; justify-content: center;">
            ...
            if (empty($error_array)) {
                ...
                if ($_POST['form_type'] == 1 || $_POST['form_type'] == 2 || $_POST['form_type'] == 4) {
                    ...
                    $where_query = array(
                        ...
                        ["OR", "id", "=", "7"],   // 4. Order Number (Number Field used)
                        ...
                        foreach ($element_data['data'] as $elements) {
                            ...
                            $builder_html .= '<div class="builder-item-wrapper clsselected_element" data-formid=' . $formData['id'] . ' data-formdataid=' . $form_data_id . ' data-positionid=' . $templates['position'] . '>
                                        <div class="list-item" data-owl="3" data-elementid=' . $elements['id'] . '>
                                            <div class="row">
                                                ...
                                                <div title="Delete this element" class="element_delete_btn">
                                                    <span class="Polaris-Icon">
                                                        <span class="Polaris-VisuallyHidden"></span>
                                                        <svg viewBox="0 0 20 20" class="Polaris-Icon__Svg" focusable="false" aria-hidden="true">
                                                            <path d="M8 3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v1h4a1 1 0 1 1 0 2h-1v10a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6H3a1 1 0 0 1 0-2h4V3zm2 2v1h4v10H6V6h4z">
                                                            </path>
                                                        </svg>
                                                    </span>
                                                </div>
                            ...
                            if ($elements['id'] == 2) {
                                ...
                                $form_html .= '<div class="code-form-control layout-' . $unserialize_elementdata[9] . '-column container_' . $elementtitle . '' . $form_data_id . '" data-id="element' . $elements['id'] . '" data-formdataid="' . $form_data_id . '">
                                    ...
                                    <div class="globo-form-input">
                                        <input type="email" data-type="email" class="classic-input 1 ' . $elementtitle . '' . $form_data_id . '__placeholder"  name="' . htmlspecialchars($field_name, ENT_QUOTES, 'UTF-8') . '" placeholder="' . $unserialize_elementdata[1] . '" value=""  maxlength="' . $limitcharacter_value . '" data-formdataid="' . $form_data_id . '"' . $element_design_style . $readonly_attr . $is_required_attr . '>
                                    </div>
                                    <small class="messages ' . $elementtitle . '' . $form_data_id . '__description">' . ((isset($unserialize_elementdata[2]) && $unserialize_elementdata[2] !== '0') ? $unserialize_elementdata[2] : '') . '</small>
                                </div>';
                            }
                            ...
                            if ($elements['id'] == 10) {
                                ...
                                $form_html .= '<div class="code-form-control layout-' . $unserialize_elementdata[10] . '-column container_' . $elementtitle . '' . $form_data_id . '" data-id="element' . $elements['id'] . '">
                                        ...
                                        <div class="globo-form-input" data-formdataid="' . $form_data_id . '">
                                            <div class="upload-area 1" id="uploadArea-' . $form_data_id . '"' . $element_design_style . '>
    ...
    .floating-form-icon {
        ...
        right: 20px;
                ...
                if ($is_storefront) {
                    ...
                    $frontend_js_url = $base_js_url . '/assets/js/shopify_front7.js';
...
(function() {
    ...
    function loadFormSubmissionScript() {
        ...
        if (document.querySelector("script[src*=\'shopify_front7.js\']")) {
            return;
        }
