                ...
                foreach($comeback_client['data'] as $templates){
                    ...
                    $html .= '<div class="Polaris-ResourceList__HeaderWrapper border-radi-unset Polaris-ResourceList__HeaderWrapper--hasAlternateTool Polaris-ResourceList__HeaderWrapper--hasSelect Polaris-ResourceList__HeaderWrapper--isSticky">
                                <div class="Polaris-ResourceList__HeaderContentWrapper">
                                    ...
                                    <div class="form_status_msg_show" style="display:none; background: #008060; color: #fff; padding: 4px 12px; border-radius: 4px; font-size: 13px; font-weight: 500; margin: 0 15px; position: absolute; right: 20%; top: -85%;"></div>
            ...
            if (empty($comebackdata) && isset($elementid)) {
                 ...
                 if (isset($check_res['data']['element_id'])) {
                     ...
                     // CASE 2: Header Or Footer
                         ...
                         if (isset($td_res['data'])) $comebackdata = $td_res['data'];
                         else $comebackdata = $inst_data; // Fallback
