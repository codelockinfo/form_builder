...
console.log('Custom code loaded');
                ...
                <div class="polarisformcontrol elementAppend" style="display:none;">                  
                </div>
                <div class="polarisformcontrol" style="display:none;">
                    <div class="header backheader">
                ...
                <div class="polarisformcontrol theme-settings-content" style="display:none;">
                    <div class="header backheader">
                        <button class="ui-btn back-icon">
                            <span class="Polaris-Icon backBtn" data-id='0'>
                                <span class="Polaris-VisuallyHidden"></span>
        ...
        function applyColorSchemeToPreview(colorScheme) {
            ...
            var applyStyles = function() {
                ...
                $('.code-form-app .star-rating fieldset label, .contact-form .star-rating fieldset label, .code-form-app .code-form-control .star-rating fieldset label, .contact-form .code-form-control .star-rating fieldset label').each(function() {
                    ...
                    // Override background: transparent !important from customstyle3.css
            ...
            var styleContent = '<style id="' + styleId + '">' +
                ...
                // IMPORTANT: Override background: transparent !important from customstyle3.css
