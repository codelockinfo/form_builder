...
<html>
    <head>
        ...
        <link rel="icon" type="image/webp" href="<?php echo main_url('assets/images/Form Builder.png'); ?>">
        <link rel="shortcut icon" type="image/webp" href="<?php echo main_url('assets/images/Form Builder.png'); ?>">
        <link rel="apple-touch-icon" href="<?php echo main_url('assets/images/Form Builder.png'); ?>">
