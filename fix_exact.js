...
fs.writeFileSync('extensions/form-builder-block/assets/form-builder-dynamic3.css', cssContent);
...
newContent = "{{ 'form-builder-dynamic3.css' | asset_url | stylesheet_tag }}\n" + newContent;
